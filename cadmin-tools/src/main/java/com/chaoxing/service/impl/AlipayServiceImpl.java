...
import com.chaoxing.domain.vo.TradeVo;
import com.chaoxing.exception.BadRequestException;
import com.chaoxing.repository.AlipayRepository;
import com.chaoxing.service.AlipayService;
...
//        double money = Double.parseDouble(trade.getTotalAmount());
    ...
    public AlipayConfig find() {
        Optional<com.chaoxing.domain.AlipayConfig> alipayConfig = alipayRepository.findById(1L);
