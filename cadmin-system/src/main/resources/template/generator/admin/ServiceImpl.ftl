...
<#if columns??>
    <#list columns as column>
        <#if column.columnKey = 'UNI'>
            <#if column_index = 1>
import com.laishishuiexception.EntityExistException;
            </#if>
        </#if>
    </#list>
</#if>
import com.laishishuiutils.ValidationUtil;
import com.laishishuiutils.FileUtil;
...
import com.laishishuiutils.PageUtil;
import com.laishishuiutils.QueryHelp;
